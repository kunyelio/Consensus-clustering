...
public class BisectingKMeansClustering extends ConsensusCluster{
	 ...
	 * is left to child classes. Here we first create a BisectingKMeans object and then call
	 * its run() method on data to obtain a BisectingKMeansModel object. Then, we call the 
	 * predict method on BisectingKMeansModel object to obtain a data structure, clusterIndexes,
